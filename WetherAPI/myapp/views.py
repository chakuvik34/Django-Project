...
def index(request):
    ...
    # checking if the method is POST
        if request.method == 'POST':
            API_KEY = '9a5d0517e45f5fd74a1855b9f6cb707e'
            # getting the city name from the form input   
            city_name = request.POST.get('city')
            # the url for current weather, takes city_name and API_KEY   
            url = f'https://api.openweathermap.org/data/2.5/weather?q={city_name}&appid={"9a5d0517e45f5fd74a1855b9f6cb707e"}&units=metric'
